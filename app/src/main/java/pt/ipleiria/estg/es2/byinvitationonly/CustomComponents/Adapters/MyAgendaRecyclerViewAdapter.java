...
public class MyAgendaRecyclerViewAdapter extends RecyclerView.Adapter<MyAgendaRecyclerViewAdapter.ViewHolder> {
    ...
    private OnEmptyListListener mListener;
    private DBAdapter dbAdapter;

    public MyAgendaRecyclerViewAdapter(Context context, List<Session> sessionList, Fragment frag) {
        inflater = LayoutInflater.from(context);
        this.context = context;
        this.sessionList = sessionList;
        this.mListener = (OnEmptyListListener) frag;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private MyAgendaRecyclerViewAdapter.ItemClickListener listener;
        ...
        public ViewHolder(View v) {
            ...
            checkBox.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    session.setOnAgenda(false);
                    dbAdapter.removeSession(session);
                    int temp = sessionList.indexOf(session);
                    sessionList.remove(session);
                    notifyItemRemoved(temp);
                    if (sessionList.isEmpty()) {
                        mListener.setVisibleEmptyData();
                    }
                }
            });
        }

        public void setClickListener(MyAgendaRecyclerViewAdapter.ItemClickListener clickListener, Session currentSession) {
